    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: form_schema_1.DynamicForm.name, schema: form_schema_1.DynamicFormSchema },
                { name: form_schema_1.FormResponse.name, schema: form_schema_1.FormResponseSchema },
            ]),
        ],
